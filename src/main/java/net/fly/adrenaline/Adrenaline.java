...
public class Adrenaline {
    ...
    public Adrenaline() {
        ...
        if (FMLEnvironment.dist == Dist.CLIENT) {
            ...
            IncompatibilityRegistry.all().forEach(incompatibility -> MinecraftForge.EVENT_BUS.register(incompatibility.controller()));
        }
